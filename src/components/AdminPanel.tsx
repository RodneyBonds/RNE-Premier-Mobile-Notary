...
export default function AdminPanel() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-dark)] font-sans text-white relative">
      ...
      {/* Header */}
      <header className="bg-[var(--color-bg-card)]/80 backdrop-blur-md shadow-md border-b border-[var(--color-accent-gold)]/20 px-6 py-4 sticky top-0 z-20">
      ...
      <main className="max-w-7xl mx-auto p-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-120px)]">
          ...
          {/* Sessions List */}
          <div className="lg:col-span-1 bg-[var(--color-bg-card)]/60 backdrop-blur-md rounded-2xl shadow-xl border border-[var(--color-accent-gold)]/20 flex flex-col overflow-hidden">
          ...
          {/* Chat Area */}
          <div className="lg:col-span-2 bg-[var(--color-bg-card)]/60 backdrop-blur-md rounded-2xl shadow-xl border border-[var(--color-accent-gold)]/20 flex flex-col overflow-hidden relative">
            {selectedSession ? (
              <>
                {/* Chat Header */}
